...
public class CoinServiceImpl implements com.example.TradingCryptoPlatformApplication.service.CoinService {
    ...
    // General method below is to return a
    // list of coins depending on the endpoint
    // and logic will be seen being copied throughout this class
    @Override
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            // Grabbing the data from the API "https://api.coingecko.com/api/v3/coins/"
